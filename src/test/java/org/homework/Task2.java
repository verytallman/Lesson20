...
public class Task2 extends BaseTestHomeWork {
    ...
    public void aboutGurockLinkCheck(){
        ...
        Assert.assertEquals(webDriver.findElement(By.xpath("//h2[contains(text(),'Outstanding customer satisfaction')]")),
                desiredText1);
        ...
        Assert.assertEquals(webDriver.findElement(By.xpath("//a[contains(text(),'2021 G2 Grid for Test Management and Software Test')]")),
                desiredText2);
    }
    ...
    public void jobsLinkCheck(){
        ...
        Assert.assertEquals(webDriver.findElement(By.xpath("//h2[contains(text(),'Browse Open Positions')]")),
                desiredText1);
        WebElement browseOpenButton = webDriver.findElement(By.xpath("//a[@class='btn btn-medium btn-outline-blue']"));
        Assert.assertEquals(webDriver.findElement(By.xpath("//a[@class='btn btn-medium btn-outline-blue']")),
                browseOpenButton);
    }
    ...
    public void сontactLinkCheck(){
        ...
        Assert.assertEquals(webDriver.findElement(By.xpath("//span[contains(text(),' +49-6103-599-6099')]")),
                desiredTelephoneNumber);
        WebElement desiredText = webDriver.findElement(By.xpath("//span[contains(text(),'HRB53083 Offenbach am Main')]"));
        Assert.assertEquals(webDriver.findElement(By.xpath("//span[contains(text(),'HRB53083 Offenbach am Main')]")),
                desiredText);
    }
